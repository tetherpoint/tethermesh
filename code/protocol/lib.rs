...
//!
//! Read `docs/WIRE_REFERENCE.md` before adding anything to this crate.
...
//! are assumed to include adversarial ones. `docs/DISTRIBUTION.md` promises three
...
//!    the language.
//!
//! `gates/check_rust_rules.sh` checks all three independently of the lints,
...
// gates/check_rust_rules.sh requires this spelling; the two move together.
