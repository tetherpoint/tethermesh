...
**Status: specified and implemented, 2026-08-17.** `code/groups/`, 9 tests,
...
**Cipher: AES-CCM**, which `code/protocol/crypto.rs` provides, with
...
`code/protocol/packet_id.rs` already refuses to reissue an id past a persisted
