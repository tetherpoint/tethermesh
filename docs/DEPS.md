...
**Known coverage hole.** XEdDSA packet signing lands in firmware 2.8.x (`docs/WIRE_REFERENCE.md`). A 2.7.26 oracle cannot exercise it. Revisit when 2.8.0 releases.
...
|---|---|---|---|
| `code/third_party/fiat-crypto` | `a6ddbd4e89e1714cb825437a401505b9c76537cf` | `fiat-rust/` only, 4.9 MB | **linked.** Coq-verified curve25519 field arithmetic, MIT/Apache-2.0/BSD-1-Clause |
| `code/third_party/libcrux` | `9ea7743c201ae861625dccb171f7c42d6b831927` | `crates/utils/` only, 744 KB | **not linked.** Basis for `docs/UPSTREAM-HACL-PANIC-FREEDOM.md` |
