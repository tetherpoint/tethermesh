...
#
# USAGE
#   tools/check_rust_rules_selftest.sh
set -euo pipefail

ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
GATE="$ROOT/tools/check_rust_rules.sh"
...
#
# A MUTANT RUNS FROM THE REAL tools/ DIRECTORY, and both alternatives were tried
...
# every glob in this tree is `tools/*.sh`, and removed by the trap below.
MUTDIR="$ROOT/tools"
