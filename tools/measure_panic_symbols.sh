...
# SAME toolchain it names (rustc 1.97.1, pinned in DEPS.md) gave 2037 / 58.
...
#
# USAGE
#   tools/measure_panic_symbols.sh            measure all candidates
#   tools/measure_panic_symbols.sh --keep     leave the scratch crates on disk
#
set -euo pipefail
...
say "DEPS.md pins rustc 1.97.1 — a different version here means the absolute"
...
say "  that is tools/check_rust_rules.sh --binary, run by tools/check_all.sh."
