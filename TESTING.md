...
- **Binaries and containers only, pinned by checksum.** `tools/fetch_oracle.sh` refuses source archives and source repositories before fetching, and `tools/oracle.manifest` pins what is fetched.
